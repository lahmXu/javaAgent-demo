...
public class Config {
     ...
     */
    @Bean
    public org.apache.shenyu.client.spring.websocket.agent.SpringWebSocketClientEventListener springWebSocketClientEventListener(
     ...
     */
    @Bean
    public org.apache.shenyu.client.spring.websocket.agent.SpringContextRegisterListener webSocketContextRegisterListener(final ShenyuClientConfig clientConfig) {
