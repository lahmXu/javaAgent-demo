...
java -javaagent:./shenyu-client-agent-spring-websocket/target/shenyu-client-agent-spring-websocket-0.0.1-SNAPSHOT.jar="./shenyu-client-agent-spring-websocket/target/shenyu-client-agent-spring-websocket-0.0.1-SNAPSHOT.jar" -jar demo/target/demo-0.0.1-SNAPSHOT.jar
